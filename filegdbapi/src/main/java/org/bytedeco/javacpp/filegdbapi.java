...
public class filegdbapi extends org.bytedeco.javacpp.presets.filegdbapi {
    static { Loader.load(); }

// Parsed from FileGDBCore.h
...
/** enum FileGDBAPI::ShapeModifiers */
public static final int
